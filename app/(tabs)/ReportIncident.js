import { View, Text, TextInput, Pressable, Modal, FlatList, Alert, Image, KeyboardAvoidingView, Platform } from "react-native";
      ...
      >
        <View className="flex-1 p-4 bg-gray-100">
          ...
          <StyledPressable
            ...
            disabled={loading}
            className={`bg-yellow-500 p-4 rounded items-center mt-4 active:bg-yellow-600 ${loading ? 'opacity-50' : ''}`}
            accessible={true}
